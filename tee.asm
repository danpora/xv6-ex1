...
//standard I/O read and write
 ...
 gets(inputString,254);
  10:	8d 9d ea fe ff ff    	lea    -0x116(%ebp),%ebx
#include "user.h"
#include "fcntl.h"
...
main(int argc, char *argv[])
{
  16:	81 ec 14 01 00 00    	sub    $0x114,%esp
  1c:	8b 71 04             	mov    0x4(%ecx),%esi

//standard I/O read and write
 char inputString[254];
 printf(0, " write something for an input: \n");
  1f:	68 30 07 00 00       	push   $0x730
  24:	6a 00                	push   $0x0
  26:	e8 e5 03 00 00       	call   410 <printf>
 gets(inputString,254);
  2b:	58                   	pop    %eax
  2c:	5a                   	pop    %edx
  2d:	68 fe 00 00 00       	push   $0xfe
  32:	53                   	push   %ebx
  33:	e8 58 01 00 00       	call   190 <gets>
 printf(1, " you entered the string: %s \n",inputString);
  38:	83 c4 0c             	add    $0xc,%esp
  3b:	53                   	push   %ebx
  3c:	68 54 07 00 00       	push   $0x754
  41:	6a 01                	push   $0x1
  43:	e8 c8 03 00 00       	call   410 <printf>
...
// Open the file for writing. If it exists, append to it otherwise, create a new file   
 int fd = open (filename, O_WRONLY | O_CREATE | O_RDWR); 
  48:	59                   	pop    %ecx
  49:	58                   	pop    %eax
  4a:	68 03 02 00 00       	push   $0x203
  4f:	ff 76 04             	pushl  0x4(%esi)
  52:	e8 ab 02 00 00       	call   302 <open>
...
// Compute the length of the fInputString string
 int length = strlen (fInputString); 
  5c:	e8 9f 00 00 00       	call   100 <strlen>
// Write the fInputString to the file 
 write (fd, fInputString, length); 
  ...
  65:	53                   	push   %ebx
  66:	56                   	push   %esi
  67:	e8 76 02 00 00       	call   2e2 <write>
 close (fd);  
  6c:	89 34 24             	mov    %esi,(%esp)
  6f:	e8 76 02 00 00       	call   2ea <close>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 7c 07 00 00 	movzbl 0x77c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 72 07 00 00       	mov    $0x772,%eax
...
free(void *ap)
{
 ...
 607:	89 08                	mov    %ecx,(%eax)
  freep = p;
 609:	a3 1c 0a 00 00       	mov    %eax,0xa1c
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 62d:	a3 1c 0a 00 00       	mov    %eax,0xa1c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ef:	89 15 1c 0a 00 00    	mov    %edx,0xa1c
      return (void*)(p + 1);
 ...
 704:	eb e9                	jmp    6ef <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 706:	c7 05 1c 0a 00 00 20 	movl   $0xa20,0xa1c
 70d:	0a 00 00 
 710:	c7 05 20 0a 00 00 20 	movl   $0xa20,0xa20
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 20 0a 00 00       	mov    $0xa20,%eax
 71f:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 726:	00 00 00 
