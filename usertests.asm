...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    exit(11);
      41:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  exit(11);
     115:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
iputtest(void)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    exit(11);
     1c3:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("/") < 0){
    ...
    exit(11);
     1e1:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("../iputdir") < 0){
    ...
    exit(11);
     1ff:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("iputdir") < 0){
    ...
    exit(11);
     21d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
// does exit(11) call iput(p->cwd) in a transaction?
void
exitiputtest(void)
{
     230:	55                   	push   %ebp
  ...
  printf(stdout, "exitiput test ok\n");
    ...
    if(unlink("../iputdir") < 0){
     ...
     2de:	e8 fd 3b 00 00       	call   3ee0 <printf>
      exit(11);
     2e3:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(pid < 0){
    ...
    exit(11);
     301:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    if(chdir("iputdir") < 0){
     ...
     31a:	e8 c1 3b 00 00       	call   3ee0 <printf>
      exit(11);
     31f:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(pid == 0){
    if(mkdir("iputdir") < 0){
     ...
     338:	e8 a3 3b 00 00       	call   3ee0 <printf>
      exit(11);
     33d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     3b0:	e8 2b 3b 00 00       	call   3ee0 <printf>
      exit(11);
     3b5:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
     ...
     40d:	e8 80 39 00 00       	call   3d92 <exit>
{
  ...
  if(mkdir("oidir") < 0){
    ...
    exit(11);
     424:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(pid < 0){
    ...
    exit(11);
     442:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("oidir") != 0){
    ...
    exit(11);
     460:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
opentest(void)
{
  ...
  if(fd < 0){
    ...
    exit(11);
     4e3:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd >= 0){
    ...
    exit(11);
     501:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
writetest(void)
{
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     668:	e8 73 38 00 00       	call   3ee0 <printf>
      exit(11);
     66d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     688:	e8 53 38 00 00       	call   3ee0 <printf>
      exit(11);
     68d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd >= 0){
    ...
    exit(11);
     6ac:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(i == 2000){
    ...
    exit(11);
     6cb:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("small") < 0){
    ...
    exit(11);
     6ea:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd >= 0){
    ...
    exit(11);
     709:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
writetest1(void)
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     84d:	e8 8e 36 00 00       	call   3ee0 <printf>
      exit(11);
     852:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    if(((int*)buf)[0] != n){
     ...
     86b:	e8 70 36 00 00       	call   3ee0 <printf>
             n, ((int*)buf)[0]);
      exit(11);
     870:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
     ...
     88b:	e8 50 36 00 00       	call   3ee0 <printf>
      exit(11);
     890:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     8af:	e8 2c 36 00 00       	call   3ee0 <printf>
        exit(11);
     8b4:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
     8d3:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
     8f2:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("big") < 0){
    ...
    exit(11);
     911:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    exit(11);
     a63:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dir0") < 0){
    ...
    exit(11);
     a81:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("..") < 0){
    ...
    exit(11);
     a9f:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("dir0") < 0){
    ...
    exit(11);
     abd:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    ...
    exit(11);
     b12:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  printf(1, "pipe1 ok\n");
    ...
    if(total != 5 * 1033){
     ...
     c71:	e8 6a 32 00 00       	call   3ee0 <printf>
      exit(11);
     c76:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
     c7d:	e8 10 31 00 00       	call   3d92 <exit>
{
  ...
  if(pipe(fds) != 0){
    ...
    exit(11);
     c91:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    exit(11);
     cac:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    for(n = 0; n < 5; n++){
     ...
     cc2:	e8 19 32 00 00       	call   3ee0 <printf>
        exit(11);
     cc7:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
mem(void)
{
  ...
  if((pid = fork()) == 0){
    ...
    exit(11);
     f3f:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    if(m1 == 0){
     ...
     f72:	e8 4b 2e 00 00       	call   3dc2 <kill>
      exit(11);
     f77:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
sharedfd(void)
{
  ...
  if(nc == 10000 && np == 10000){
    ...
    exit(11);
    1142:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles ok\n");
    ...
    1283:	e8 58 2c 00 00       	call   3ee0 <printf>
          exit(11);
    1288:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    1300:	e8 db 2b 00 00       	call   3ee0 <printf>
          exit(11);
    1305:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    131b:	e8 c0 2b 00 00       	call   3ee0 <printf>
        exit(11);
    1320:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    1337:	e8 a4 2b 00 00       	call   3ee0 <printf>
      exit(11);
    133c:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    1352:	e8 89 2b 00 00       	call   3ee0 <printf>
      exit(11);
    1357:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
createdelete(void)
{
  ...
  printf(1, "createdelete ok\n");
    ...
    150f:	e8 cc 29 00 00       	call   3ee0 <printf>
            exit(11);
    1514:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    1535:	e8 a6 29 00 00       	call   3ee0 <printf>
        exit(11);
    153a:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    1550:	e8 8b 29 00 00       	call   3ee0 <printf>
          exit(11);
    1555:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    156b:	e8 70 29 00 00       	call   3ee0 <printf>
      exit(11);
    1570:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    158f:	e8 4c 29 00 00       	call   3ee0 <printf>
        exit(11);
    1594:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
unlinkread(void)
{
  ...
  if(fd < 0){
    ...
    exit(11);
    16c4:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(write(fd, buf, 10) != 10){
    ...
    exit(11);
    16de:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(buf[0] != 'h'){
    ...
    exit(11);
    16f8:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    exit(11);
    1712:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("unlinkread") != 0){
    ...
    exit(11);
    172c:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    1746:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
linktest(void)
{
  ...
  if(fd < 0){
    ...
    exit(11);
    18d3:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(link(".", "lf1") >= 0){
    ...
    exit(11);
    18ed:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    exit(11);
    1907:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    exit(11);
    1921:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    exit(11);
    193b:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    1955:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(open("lf1", 0) >= 0){
    ...
    exit(11);
    196f:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(link("lf1", "lf2") < 0){
    ...
    exit(11);
    1989:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    exit(11);
    19a3:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
concreate(void)
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1a88:	e8 53 24 00 00       	call   3ee0 <printf>
        exit(11);
    1a8d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  for(i = 0; i < 40; i++){
    ...
    1c71:	e8 6a 22 00 00       	call   3ee0 <printf>
      exit(11);
    1c76:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(n != 40){
    ...
    exit(11);
    1c91:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    1cab:	e8 30 22 00 00       	call   3ee0 <printf>
        exit(11);
    1cb0:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    1cca:	e8 11 22 00 00       	call   3ee0 <printf>
        exit(11);
    1ccf:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
linkunlink()
{
  ...
  if(pid < 0){
    ...
    exit(11);
    1de9:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
bigdir(void)
{
  ...
  printf(1, "bigdir ok\n");
    ...
    1efc:	e8 df 1f 00 00       	call   3ee0 <printf>
      exit(11);
    1f01:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    1f17:	e8 c4 1f 00 00       	call   3ee0 <printf>
      exit(11);
    1f1c:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    1f37:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
subdir(void)
{
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    exit(11);
    23a5:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    exit(11);
    23bf:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    exit(11);
    23d9:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    exit(11);
    23f3:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    exit(11);
    240d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    exit(11);
    2427:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    exit(11);
    2441:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    245b:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    2475:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("./..") != 0){
    ...
    exit(11);
    248f:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    exit(11);
    24a9:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    exit(11);
    24c3:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    exit(11);
    24dd:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    exit(11);
    24f7:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    exit(11);
    2511:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    exit(11);
    252b:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    exit(11);
    2545:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("dd") != 0){
    ...
    exit(11);
    255f:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    exit(11);
    2579:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    exit(11);
    2593:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dd") >= 0){
    ...
    exit(11);
    25ad:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    25c7:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(mkdir("dd") != 0){
    ...
    exit(11);
    25e1:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dd") < 0){
    ...
    exit(11);
    25fb:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dd/dd") < 0){
    ...
    exit(11);
    2615:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dd") == 0){
    ...
    exit(11);
    262f:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dd/ff") != 0){
    ...
    exit(11);
    2649:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("dd/xx") == 0){
    ...
    exit(11);
    2663:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("dd/ff") == 0){
    ...
    exit(11);
    267d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    exit(11);
    2697:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    exit(11);
    26b1:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    exit(11);
    26cb:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    exit(11);
    26e5:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    exit(11);
    26ff:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    2719:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite ok\n");
    ...
    27f3:	e8 e8 16 00 00       	call   3ee0 <printf>
        exit(11);
    27f8:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    280e:	e8 cd 16 00 00       	call   3ee0 <printf>
      exit(11);
    2813:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
bigfile(void)
{
  ...
  printf(1, "bigfile test ok\n");
    ...
    2962:	e8 79 15 00 00       	call   3ee0 <printf>
      exit(11);
    2967:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    297d:	e8 5e 15 00 00       	call   3ee0 <printf>
      exit(11);
    2982:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  for(i = 0; ; i++){
    ...
    2998:	e8 43 15 00 00       	call   3ee0 <printf>
      exit(11);
    299d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  for(i = 0; i < 20; i++){
    ...
    29b3:	e8 28 15 00 00       	call   3ee0 <printf>
      exit(11);
    29b8:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    29d3:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    29ee:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(total != 20*600){
    ...
    exit(11);
    2a09:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
fourteen(void)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    exit(11);
    2af2:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    exit(11);
    2b0c:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    exit(11);
    2b26:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    2b40:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    2b5a:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    exit(11);
    2b74:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    ...
    exit(11);
    2c6b:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dots") != 0){
    ...
    exit(11);
    2c85:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dots/..") == 0){
    ...
    exit(11);
    2c9f:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dots/.") == 0){
    ...
    exit(11);
    2cb9:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("/") != 0){
    ...
    exit(11);
    2cd3:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("..") == 0){
    ...
    exit(11);
    2ced:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink(".") == 0){
    ...
    exit(11);
    2d07:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    exit(11);
    2d21:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
dirfile(void)
{
  ...
  if(fd >= 0){
    ...
    exit(11);
    2e8a:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(chdir("dirfile") == 0){
    ...
    exit(11);
    2ea4:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    2ebe:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(write(fd, "x", 1) > 0){
    ...
    exit(11);
    2ed8:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd >= 0){
    ...
    exit(11);
    2ef2:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dirfile") != 0){
    ...
    exit(11);
    2f0c:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    exit(11);
    2f26:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    exit(11);
    2f40:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    exit(11);
    2f5a:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
iref(void)
{
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    306d:	e8 6e 0e 00 00       	call   3ee0 <printf>
      exit(11);
    3072:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    3088:	e8 53 0e 00 00       	call   3ee0 <printf>
      exit(11);
    308d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    30c0:	74 69                	je     312b <forktest+0x8b>
{
  ...
  if(n == 1000){
    ...
    exit(11);
    311f:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  for(; n > 0; n--){
    ...
    313f:	e8 9c 0d 00 00       	call   3ee0 <printf>
      exit(11);
    3144:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(wait() != -1){
    ...
    exit(11);
    315f:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    exit(11);
    347d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(pipe(fds) != 0){
    ...
    exit(11);
    3498:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    34bc:	e8 01 09 00 00       	call   3dc2 <kill>
      exit(11);
    34c1:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    34db:	e8 00 0a 00 00       	call   3ee0 <printf>
      exit(11);
    34e0:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(c != a){
    ...
    exit(11);
    34fe:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(*lastaddr == 99){
    ...
    exit(11);
    351d:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    exit(11);
    353b:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(c != a - 4096){
    ...
    exit(11);
    3559:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(c == (char*)0xffffffff){
    ...
    exit(11);
    3578:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    exit(11);
    3597:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(c != a + 1){
    ...
    exit(11);
    35c0:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(pid < 0){
    ...
    exit(11);
    35df:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
validatetest(void)
{
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    36a6:	e8 35 08 00 00       	call   3ee0 <printf>
      exit(11);
    36ab:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
bsstest(void)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3725:	e8 b6 07 00 00       	call   3ee0 <printf>
      exit(11);
    372a:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
bigargtest(void)
{
  ...
  if(pid == 0){
    ...
    exit(11);
    3808:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
  ...
  if(fd < 0){
    ...
    exit(11);
    3826:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    exit(11);
    3844:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
uio()
{
  ...
  if(pid == 0){
    ...
    exit(11);
    3a98:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
    ...
    exit(11);
    3ab2:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
...
void argptest()
{
  ...
  if (fd < 0) {
    ...
    exit(11);
    3b21:	c7 04 24 0b 00 00 00 	movl   $0xb,(%esp)
