...
main(int argc, char *argv[])
{
  ...
  15:	ff 73 08             	pushl  0x8(%ebx)
  18:	ff 73 04             	pushl  0x4(%ebx)
  1b:	e8 12 03 00 00       	call   332 <set>
    printf(2, "set.c file: %s\n", argv[1]);
  20:	83 c4 0c             	add    $0xc,%esp
  23:	ff 73 04             	pushl  0x4(%ebx)
  26:	68 00 07 00 00       	push   $0x700
  2b:	6a 02                	push   $0x2
  2d:	e8 ae 03 00 00       	call   3e0 <printf>
    printf(2, "set.c file: %s\n", argv[2]);
  32:	83 c4 0c             	add    $0xc,%esp
  35:	ff 73 08             	pushl  0x8(%ebx)
  38:	68 00 07 00 00       	push   $0x700
  3d:	6a 02                	push   $0x2
  3f:	e8 9c 03 00 00       	call   3e0 <printf>
    exit(0);
  44:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  4b:	e8 42 02 00 00       	call   292 <exit>
